...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "Vastaukset.findAll", query = "SELECT v FROM Vastaukset v"),
...
public class Vastaukset implements Serializable {
	...
	public boolean equals(Object object) {
		...
		return !((this.vastauksetPK == null && other.vastauksetPK != null)
				|| (this.vastauksetPK != null && !this.vastauksetPK.equals(other.vastauksetPK)));
	}
